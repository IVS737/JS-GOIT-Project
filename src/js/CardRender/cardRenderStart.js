    ...
    .map((data) => {
      ...
      <div class="card-wrapper">
        <div class="card-thumb">
          ...
          <button class="favourite-button" type="button" data-action="favourite-button">Add to favorite
        ...
        <div class="card-info-container">
          ...
          <a class="card-link" href="${data.short_url}" target="_blank" rel="noopener noreferrer nofollow">Read more</a>
        </div>
      </div>
  </li>`;
    })
